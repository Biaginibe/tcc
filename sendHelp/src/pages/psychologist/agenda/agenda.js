	...
	useEffect(() => {
		async function getSchedule() {
			try {
				...
				if (delet != null) {
					try {
						await instance.delete(`/psychologist/1/${delet}/deleteSchedule`);
						setDelete(null);
					} catch {
						console.error(err);
					}
		...
		<>
			<View style={{ display: 'flex' }}>
				<FlatList
					...
					renderItem={({ item }) => (
						<TouchableOpacity onPress={() => updateSchedule(item.id)}>
							<ListItem bottomDivider style={css.container}>
								<ListItem.Content>
									...
									>
										<Ionicons name="md-trash-sharp" size={24} color="#970000" />
									</TouchableOpacity>
								</ListItem.Content>
							</ListItem>
						</TouchableOpacity>
			...
			>
				<SafeAreaView style={css.modal}>
						...
						<View style={{ marginBottom: 15, padding: 10 }}>
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Segunda"
									status={dia === 'Segunda' ? 'checked' : 'unchecked'}
							...
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Terça"
									status={dia === 'Terça' ? 'checked' : 'unchecked'}
							...
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Quarta"
									status={dia === 'Quarta' ? 'checked' : 'unchecked'}
							...
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Quinta"
									status={dia === 'Quinta' ? 'checked' : 'unchecked'}
							...
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Sexta"
									status={dia === 'Sexta' ? 'checked' : 'unchecked'}
							...
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Sabado"
									status={dia === 'Sabado' ? 'checked' : 'unchecked'}
							...
							<View style={css.radio}>
								<RadioButton
									color="#053260"
									value="Domingo"
									status={dia === 'Domingo' ? 'checked' : 'unchecked'}
					...
					<View style={css.inline}>
						<TouchableOpacity style={css.botao} onPress={pressAdd}>
							<Text style={css.textModal}>Adicionar horario</Text>
						</TouchableOpacity>
			...
			>
				<SafeAreaView style={css.modal}>
					...
					<View style={css.inline}>
						<TouchableOpacity style={css.botao} onPress={pressUpdate}>
